...
from db_common import query_turso, _esc, init_state_table, set_state
...
def main():
    ...
    try:
        ...
        if not rows:
            ...
            set_state("sync", "OK")  # script ran fine — device just has nothing new
            return
